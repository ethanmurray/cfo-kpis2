          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl p-6 shadow-lg" style={{
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-xl font-bold" style={{ color: 'var(--client-text)' }}>Risk Metrics by Category</h2>
                  ...
                  {riskByCategory.map((item, idx) => (
                    <div key={idx} className="p-4 rounded-xl" style={{
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div>
                          <span className="text-sm font-semibold" style={{ color: 'var(--client-text)' }}>{item.category}</span>
            ...
            <div className="rounded-2xl p-6 shadow-lg" style={{
              ...
              <h3 className="font-bold text-sm tracking-wide uppercase mb-4" style={{ color: 'var(--client-text)' }}>
          ...
          <div className="space-y-6">
            <div className="rounded-2xl p-6 shadow-lg" style={{
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold" style={{ color: 'var(--client-text)' }}>Risk Appetite Framework</h2>
              </div>
                  ...
                  <div key={idx} className="p-4 rounded-xl bg-white border border-gray-100">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        <span className="text-sm font-semibold" style={{ color: 'var(--client-text)' }}>{item.metric}</span>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl p-6 shadow-lg" style={{
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold" style={{ color: 'var(--client-text)' }}>Compliance Activity by Category</h2>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl p-6 shadow-lg" style={{
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold" style={{ color: 'var(--client-text)' }}>Regulatory Examination Status</h2>
              </div>
                ...
                {examStatus.map((item, idx) => (
                  <div key={idx} className="p-4 rounded-xl bg-white border border-gray-100">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-3">
                          <span className="text-sm font-bold" style={{ color: 'var(--client-text)' }}>{item.regulator}</span>
            ...
            <div className="rounded-2xl p-6 shadow-lg" style={{
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold" style={{ color: 'var(--client-text)' }}>Upcoming Regulatory Changes</h2>
              </div>
                ...
                {upcomingRegChanges.map((item, idx) => (
                  <div key={idx} className="p-4 rounded-xl bg-white border border-gray-100">
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        <div className="flex items-center gap-3">
                          <span className="text-sm font-bold" style={{ color: 'var(--client-text)' }}>{item.regulation}</span>
                          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
            ...
            <TabsContent value="sox-compliance">
              <div className="space-y-6">
                ...
                <div className="rounded-2xl p-6 shadow-lg" style={{
                  ...
                  <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--client-text)' }}>SOX 302/404 Testing Status by Quarter</h3>
                ...
                <div className="rounded-2xl p-6 shadow-lg" style={{
                  ...
                  <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--client-text)' }}>Certification Timeline & Milestones</h3>
                  <div className="space-y-3">
                ...
                <div className="rounded-2xl p-6 shadow-lg" style={{
                  ...
                  <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--client-text)' }}>IT General Controls (ITGCs) Status</h3>
            ...
            <TabsContent value="process-controls">
              <div className="space-y-6">
                ...
                <div className="rounded-2xl p-6 shadow-lg" style={{
                  ...
                  <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--client-text)' }}>Control Effectiveness by Process Area</h3>
                  <div className="overflow-x-auto">
                    <table className="min-w-full text-xs">
                      <thead className="bg-gray-50">
                        <tr>
                ...
                <div className="rounded-2xl p-6 shadow-lg" style={{
                  ...
                  <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--client-text)' }}>Key Control Risk Indicators (KRIs)</h3>
                  <div className="space-y-3">
            ...
            <TabsContent value="deficiencies">
              <div className="space-y-6">
                ...
                <div className="rounded-2xl p-6 shadow-lg" style={{
                  ...
                  <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--client-text)' }}>Deficiency Details & Remediation Status</h3>
                  <div className="space-y-3">
                ...
                <div className="rounded-2xl p-6 shadow-lg" style={{
                  ...
                  <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--client-text)' }}>Required Remediation Actions</h3>
                  <div className="space-y-4">
